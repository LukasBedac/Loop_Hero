            ...
            for (int i = 0; i < enemies.Count; i++)
            {
                ...
                if (cardLoot > 0.75)
                {
                    _player?.AddCard(new TreasureCard());
                     loot = "<span style=\"color: red;\">" + "You got a card: Treasure" + "</span>";
                    
                } else if (cardLoot > 0.5) 
                {
                    _player?.AddCard(new CemeteryCard());
                     loot = "<span style=\"color: red;\">" + "You got a card: Cemetery" + "</span>";
                    
                }
                else if (cardLoot > 0.25)
                {
                    _player?.AddCard(new ForestCard());
                     loot = "<span style=\"color: red;\">" + "You got a card: Forest" + "</span>";
                    
                }
                _listBox.Items.Add(loot);
            }
        }*/
    }
}
